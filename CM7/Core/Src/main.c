...
static void MX_DFSDM1_Init(void)
{
  ...
  hdfsdm1_channel2.Init.OutputClock.Divider = 150;
  ...
  hdfsdm1_channel3.Init.OutputClock.Divider = 150;
  ...
  hdfsdm1_channel4.Init.OutputClock.Divider = 150;
  ...
  hdfsdm1_channel5.Init.OutputClock.Divider = 150;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOE, CH3_Pin|SPI_CS_Pin|LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, CH1_Pin|CH2_Pin|CH0_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : CH3_Pin SPI_CS_Pin LED_Pin */
  GPIO_InitStruct.Pin = CH3_Pin|SPI_CS_Pin|LED_Pin;
  ...
  /*Configure GPIO pins : CH1_Pin CH2_Pin CH0_Pin */
  GPIO_InitStruct.Pin = CH1_Pin|CH2_Pin|CH0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
